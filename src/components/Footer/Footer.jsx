...
const Footer = () => {
    return (
        <footer className="footer flex justify-around mt-7 rounded-xl footer-center p-10 bg-black text-primary-content">
  <aside>
    ...
    <p className="font-bold">
      Textile Arts Industries Ltd. <br/>Providing reliable tech since 2023
    </p>
  ...
  <div className="font-semibold">
        <h2>Name: Md.Sobayel Hossain</h2>
        <p>Email: mdsobayelhossain@gmail.com</p>
    </div>
